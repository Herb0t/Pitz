...
var ASM_CONSTS = {
  4505680: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4505735: ($0) => { performance.now = function() { return $0; }; },  
 4505783: ($0) => { performance.now = function() { return $0; }; },  
 4505831: () => { performance.now = Module['emscripten_get_now_backup']; }
};
