...
var ASM_CONSTS = {
  4505264: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4505319: ($0) => { performance.now = function() { return $0; }; },  
 4505367: ($0) => { performance.now = function() { return $0; }; },  
 4505415: () => { performance.now = Module['emscripten_get_now_backup']; }
};
